...
class MovementsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create movement" do
    assert_difference('Movement.count') do
      post movements_url, params: { movement: { account_id: @movement.account_id, amount: @movement.amount, description: @movement.description, movement_date: @movement.movement_date, movement_type: @movement.movement_type } }
    end
  ...
  test "should update movement" do
    patch movement_url(@movement), params: { movement: { account_id: @movement.account_id, amount: @movement.amount, description: @movement.description, movement_date: @movement.movement_date, movement_type: @movement.movement_type } }
