...
class PilotsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create pilot" do
    assert_difference('Pilot.count') do
      post pilots_url, params: { pilot: { first_name: @pilot.first_name, last_name: @pilot.last_name } }
    end
  ...
  test "should update pilot" do
    patch pilot_url(@pilot), params: { pilot: { first_name: @pilot.first_name, last_name: @pilot.last_name } }
