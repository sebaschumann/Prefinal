class RacesController < ApplicationController
  ...
  def index
    @races = Race.all
    @races = @races.where(:championship_id => params[:championship_id]) unless params[:championship_id].blank?
  ...
  private
    ...
    def race_params
      params.require(:race).permit(:name, :championship_id, :circuit_id)
    end
end
